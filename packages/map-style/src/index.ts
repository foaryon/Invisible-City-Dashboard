...
export const analyticalLayers: AnalyticalLayer[] = [
  ...
  },
  {
    ...
    legend: [
      ...
      { swatch: '#e0574d', shape: 'circle', label: 'Defibrillator/AED (kartiert)' },
      { swatch: '#e07a9b', shape: 'circle', label: 'Krankenhaus (kartiert)' },
      { swatch: '#d98452', shape: 'circle', label: 'Feuerwache (kartiert)' },
